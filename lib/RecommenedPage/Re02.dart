...
class Re02 extends StatefulWidget {
  const Re02({Key? key}) : super(key: key);

  @override
  State<Re02> createState() => _Re02State();
}

class _Re02State extends State<Re02> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/022.jpg"),
