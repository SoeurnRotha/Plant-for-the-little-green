...
class Re05 extends StatefulWidget {
  const Re05({Key? key}) : super(key: key);

  @override
  State<Re05> createState() => _Re05State();
}

class _Re05State extends State<Re05> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/025.jpg"),
