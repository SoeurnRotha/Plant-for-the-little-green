...
class Re09 extends StatefulWidget {
  const Re09({Key? key}) : super(key: key);

  @override
  State<Re09> createState() => _Re09State();
}

class _Re09State extends State<Re09> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/029.jpg"),
