...
class Image020 extends StatefulWidget {
  const Image020({Key? key}) : super(key: key);

  @override
  State<Image020> createState() => _Image020State();
}

class _Image020State extends State<Image020> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/020.jpg"),
