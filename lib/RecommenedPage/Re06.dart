...
class Re06 extends StatefulWidget {
  const Re06({Key? key}) : super(key: key);

  @override
  State<Re06> createState() => _Re06State();
}

class _Re06State extends State<Re06> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/026.jpg"),
