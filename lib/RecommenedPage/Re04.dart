...
class Re04 extends StatefulWidget {
  const Re04({Key? key}) : super(key: key);

  @override
  State<Re04> createState() => _Re04State();
}

class _Re04State extends State<Re04> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/024.jpg"),
