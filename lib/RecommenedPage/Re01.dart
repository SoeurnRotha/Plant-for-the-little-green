...
class Re01 extends StatefulWidget {
  const Re01({Key? key}) : super(key: key);

  @override
  State<Re01> createState() => _Re01State();
}

class _Re01State extends State<Re01> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/021.jpg"),
