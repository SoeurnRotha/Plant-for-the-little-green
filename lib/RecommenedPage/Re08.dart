...
class Re08 extends StatefulWidget {
  const Re08({Key? key}) : super(key: key);

  @override
  State<Re08> createState() => _Re08State();
}

class _Re08State extends State<Re08> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/028.jpg"),
