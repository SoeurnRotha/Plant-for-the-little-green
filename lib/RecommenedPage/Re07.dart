...
class Re07 extends StatefulWidget {
  const Re07({Key? key}) : super(key: key);

  @override
  State<Re07> createState() => _Re07State();
}

class _Re07State extends State<Re07> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/027.jpg"),
