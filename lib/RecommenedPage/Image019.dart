...
class Image019 extends StatefulWidget {
  const Image019({Key? key}) : super(key: key);

  @override
  State<Image019> createState() => _Image019State();
}

class _Image019State extends State<Image019> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/019.jpg"),
