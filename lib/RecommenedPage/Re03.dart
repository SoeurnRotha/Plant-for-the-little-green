...
class Re03 extends StatefulWidget {
  const Re03({Key? key}) : super(key: key);

  @override
  State<Re03> createState() => _Re03State();
}

class _Re03State extends State<Re03> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/023.jpg"),
