...
class Sell09 extends StatefulWidget {
  const Sell09({Key? key}) : super(key: key);

  @override
  State<Sell09> createState() => _Sell09State();
}

class _Sell09State extends State<Sell09> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/07.jpg"),
