...
class Sell05 extends StatefulWidget {
  const Sell05({Key? key}) : super(key: key);

  @override
  State<Sell05> createState() => _Sell05State();
}

class _Sell05State extends State<Sell05> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/03.jpg"),
