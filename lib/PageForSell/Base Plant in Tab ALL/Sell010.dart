...
class Sell010 extends StatefulWidget {
  const Sell010({Key? key}) : super(key: key);

  @override
  State<Sell010> createState() => _Sell010State();
}

class _Sell010State extends State<Sell010> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/08.jpg"),
