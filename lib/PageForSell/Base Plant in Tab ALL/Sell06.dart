...
class Sell06 extends StatefulWidget {
  const Sell06({Key? key}) : super(key: key);

  @override
  State<Sell06> createState() => _Sell06State();
}

class _Sell06State extends State<Sell06> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/04.jpg"),
