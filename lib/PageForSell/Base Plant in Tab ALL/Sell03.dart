...
class Sell03 extends StatefulWidget {
  const Sell03({Key? key}) : super(key: key);

  @override
  State<Sell03> createState() => _Sell03State();
}

class _Sell03State extends State<Sell03> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/01.jpg"),
