...
class Sell07 extends StatefulWidget {
  const Sell07({Key? key}) : super(key: key);

  @override
  State<Sell07> createState() => _Sell07State();
}

class _Sell07State extends State<Sell07> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/05.jpg"),
