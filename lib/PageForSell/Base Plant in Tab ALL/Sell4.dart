...
class Sell04 extends StatefulWidget {
  const Sell04({Key? key}) : super(key: key);

  @override
  State<Sell04> createState() => _Sell04State();
}

class _Sell04State extends State<Sell04> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/02.jpg"),
