...
class Sell08 extends StatefulWidget {
  const Sell08({Key? key}) : super(key: key);

  @override
  State<Sell08> createState() => _Sell08State();
}

class _Sell08State extends State<Sell08> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/06.jpg"),
