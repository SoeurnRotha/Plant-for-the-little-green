...
class Pop020 extends StatefulWidget {
  const Pop020({Key? key}) : super(key: key);

  @override
  State<Pop020> createState() => _Pop020State();
}

class _Pop020State extends State<Pop020> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/018.jpg"),
