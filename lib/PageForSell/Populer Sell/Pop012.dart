...
class Pop012 extends StatefulWidget {
  const Pop012({Key? key}) : super(key: key);

  @override
  State<Pop012> createState() => _Pop012State();
}

class _Pop012State extends State<Pop012> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/010.jpg"),
