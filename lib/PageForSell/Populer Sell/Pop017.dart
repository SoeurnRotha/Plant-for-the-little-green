...
class Pop017 extends StatefulWidget {
  const Pop017({Key? key}) : super(key: key);

  @override
  State<Pop017> createState() => _Pop017State();
}

class _Pop017State extends State<Pop017> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/015.jpg"),
