...
class Pop019 extends StatefulWidget {
  const Pop019({Key? key}) : super(key: key);

  @override
  State<Pop019> createState() => _Pop019State();
}

class _Pop019State extends State<Pop019> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/017.jpg"),
