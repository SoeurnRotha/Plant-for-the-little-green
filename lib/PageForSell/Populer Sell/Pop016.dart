...
class Pop016 extends StatefulWidget {
  const Pop016({Key? key}) : super(key: key);

  @override
  State<Pop016> createState() => _Pop016State();
}

class _Pop016State extends State<Pop016> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/014.jpg"),
