...
class Pop015 extends StatefulWidget {
  const Pop015({Key? key}) : super(key: key);

  @override
  State<Pop015> createState() => _Pop015State();
}

class _Pop015State extends State<Pop015> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/013.jpg"),
