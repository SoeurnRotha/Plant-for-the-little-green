...
class Pop018 extends StatefulWidget {
  const Pop018({Key? key}) : super(key: key);

  @override
  State<Pop018> createState() => _Pop018State();
}

class _Pop018State extends State<Pop018> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/016.jpg"),
