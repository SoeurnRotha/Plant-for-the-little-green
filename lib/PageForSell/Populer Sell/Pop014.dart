...
class Pop014 extends StatefulWidget {
  const Pop014({Key? key}) : super(key: key);

  @override
  State<Pop014> createState() => _Pop014State();
}

class _Pop014State extends State<Pop014> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/012.jpg"),
