...
class Pop013 extends StatefulWidget {
  const Pop013({Key? key}) : super(key: key);

  @override
  State<Pop013> createState() => _Pop013State();
}

class _Pop013State extends State<Pop013> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/011.jpg"),
