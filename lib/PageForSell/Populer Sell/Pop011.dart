...
class Pop011 extends StatefulWidget {
  const Pop011({Key? key}) : super(key: key);

  @override
  State<Pop011> createState() => _Pop011State();
}

class _Pop011State extends State<Pop011> {
  @override
  ...
  get _buildBody => SingleChildScrollView(
    child: Container(
      ...
      child: Column(
        children: [
          _buildImage("images/Sell/09.jpg"),
